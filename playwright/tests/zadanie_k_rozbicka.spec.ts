...
test("get started link", async ({ page }) => {
  ...
  await expect(page).toHaveURL(/.*telemedi/);
});

test("has title login page", async ({ page }) => {
  // go to website
  await page.goto("https://panel.telemedi.com/pl/login");
...
test("has title make consultation page", async ({ page }) => {
  // go to website
  await page.goto("https://panel.telemedi.com/pl");
...
test("zadanie calosc", async ({ page }) => {
  // Przejście na adres: https://telemedi.com/pl/
  await page.goto("https://telemedi.com/pl/");
  ...
  const checkboxTelemediGO = await page.locator("div.telemedi-go");
  await checkboxTelemediGO.click();
